...
- Consider buying SiO₂ on Si wafer to isolate the metal from the bulk Si. Without SiO₂, applying voltage to a metal electrode with direct contact with silicon will result in having to driving current flow through the substrate, limited voltage handling, and possible device breakdown.

- Consider buying SiO₂ on Si wafer to isolate the metal from the bulk Si. Without SiO₂, applying a voltage to a metal electrode with direct contact with silicon will result in having to drive current flow through the substrate.
