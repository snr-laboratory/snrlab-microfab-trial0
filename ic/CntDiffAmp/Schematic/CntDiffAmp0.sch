...
C {devices/lab_pin.sym} 700 -470 0 0 {name=p22 sig_type=std_logic lab=Vinp}
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 720 -470 0 0 {name=M2
L=2
W=10
nf=1
mult=1
...
C {devices/ipin.sym} 80 -860 0 0 {name=pio4 lab=Vinp sim_pinnumber=4}
...
C {devices/lab_pin.sym} 780 -470 0 1 {name=p18 sig_type=std_logic lab=Vdd}
