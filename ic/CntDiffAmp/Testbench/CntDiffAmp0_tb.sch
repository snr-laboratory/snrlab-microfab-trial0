...
C {../Schematic/CntDiffAmp0.sym} 720 -410 0 0 {name=x1}
...
C {devices/lab_pin.sym} 820 -410 0 1 {name=p7 sig_type=std_logic lab=Vbo}
...
C {../Schematic/CntDiffAmp0a.sym} 570 -970 0 0 {name=x2}
